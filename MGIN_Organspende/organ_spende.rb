...
class Organspende
  ...
  def self.abfrage_patient_blutgruppe(blutgruppePatient)
  ...
  def self.abfrage_spender_blutgruppe(blutgruppeSpender)
  ...
  def self.kompatibilitaet_blutgruppe(blutgruppePatient, blutgruppeSpender)
